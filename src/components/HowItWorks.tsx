...
const steps = [
  {
    ...
    title: "Upload File",
    description:
      "Drag & drop or click to upload your file. All formats supported.",
  },
  {
    icon: RefreshCw,
    step: "2",
    ...
    description:
      "Choose your desired output format and let us handle the rest.",
  },
  {
    icon: Download,
    step: "3",
    ...
    description:
      "Download your file instantly. It's then permanently deleted from our servers.",
  },
];
